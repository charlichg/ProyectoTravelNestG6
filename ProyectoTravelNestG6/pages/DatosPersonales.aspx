<%@ Page Title="" Language="C#" MasterPageFile="~/SitePublic.Master" AutoEventWireup="true" CodeBehind="DatosPersonales.aspx.cs" Inherits="ProyectoTravelNestG6.Formulario_web1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div style="color: #000000">
            <h1>
                ...
                <link href="../styles/generales/DatosPersonales.css" rel="stylesheet" />
            </h1>
        </div>
<div class="row">
